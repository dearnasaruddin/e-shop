    ...
    <div className='mb-10 lg:mb-20'>
      <Container>
        <div className='mt-4 lg:mt-8 mb-4 lg:mb-16 rounded-2xl overflow-hidden'>
          <iframe className='w-full max-sm:h-50 lg:h-150' src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1009.297893546715!2d-73.831222!3d40.7622149!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c2600feab8eaf3%3A0xf2c8bcc288c78f3!2s123%20Main%20St%2C%20Queens%2C%20NY%2010001%2C%20USA!5e1!3m2!1sen!2sbd!4v1751622140604!5m2!1sen!2sbd" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div>
          ...
          <div className='flex justify-between gap-10 lg:gap-14 flex-wrap-reverse'>

            {/* ========== Provide Your Info ========== */}
            <div>
              <h1 className='font-poppins text-3xl sm:text-4xl sm:leading-11.5 text-secondary'>Contact Us</h1>
              <p className='font-montserrat font-normal text-base max-sm:max-w-60 sm:text-xl leading-7.5 text-secondary mt-3 mb-6 lg:mb-12'>Have any questions for us? Don’t hesitate to contact us.</p>
              <div>
            ...
            {/* ========== Contact Information ========== */}
            <div>
              <div className='rounded-lg lg:rounded-3xl max-sm:p-8 lg:py-10 lg:pl-10 lg:pr-22 bg-[#F4F4F4]'>
                <h5 className='font-poppins font-semibold text-2xl leading-7.5 text-secondary'>Let’s Keep in Touch!</h5>
                <p className='max-w-117 font-montserrat font-normal text-base sm:text-xl leading-7.5 text-[#616161] mt-2 lg:mt-4 mb-6 lg:mb-10'>We would love to hear from you. Contact us for
                ...
                <span className='font-montserrat font-bold text-xl leading-7.5 text-secondary mt-6 lg:mt-14 mb-4 lg:mb-8 inline-block relative after:absolute after:w-full after:h-1 after:bg-primary after:-bottom-1 after:left-0'>Opening Hours</span>
