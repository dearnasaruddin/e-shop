            ...
            <div className='pb-6 lg:pb-25 border-b border-[#CBCBCB]'>
                <Container>
                    <div>
                        ...
                        <div className='max-lg:hidden flex max-lg:justify-between py-3 lg:py-8 pl-4 lg:pl-14 max-lg:pr-4 bg-[#F4F4F4] font-montserrat font-bold text-base leading-6 uppercase text-secondary rounded-lg lg:rounded-2xl mt-7 mb-8'>
                            <h6>PRODUCT</h6>
                        ...
                        <div className='flex justify-between items-center max-md:gap-3 flex-wrap'>
                            <div className='relative max-md:w-full'>
                                <input type="text" className='w-full lg:w-154.5 py-4 lg:py-9 max-lg:pl-3  max-lg:pr-30 lg:pl-9 lg:pr-48 border border-[#CBCBCB] rounded-[10px] font-montserrat font-normal text-sm lg:text-base leading-6 text-[#646464]' placeholder='Enter coupon code (ex: FIRSTPAY)' />
                            ...
                            <div className='py-1.5 lg:py-8 px-4 lg:px-9 max-md:w-full flex md:gap-x-6 lg:gap-x-44 justify-between items-center bg-[#F4F4F4] rounded-[10px]'>
                                <h4 className='uppercase grow font-montserrat font-bold text-base leading-6 text-secondary'>Sub Total</h4>
                                <div className='flex max-lg:flex-col lg:gap-x-6'>
                        ...
                        <div className='flex max-sm:items-center gap-x-4 justify-center md:justify-end max-md:py-4 md:mt-4 lg:mt-8'>
