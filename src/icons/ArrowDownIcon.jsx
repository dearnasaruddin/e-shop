...
const ArrowDownIcon = ({className, rotate = '0deg', color='#303030', width='16', height='16' }) => {
    return (
        <svg style={{ rotate: rotate }} className={`duration-300 ${className}`} width={width} height={height} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
