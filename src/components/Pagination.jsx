    ...
    return (
        <div className='flex justify-center items-center lg:gap-x-9'>
            ...
            <div className='flex justify-center items-center lg:gap-x-7.5'>
                <button onClick={() => onPageChange(1)} className={`size-8 lg:size-12 flex justify-center items-center rounded-sm font-poppins font-semibold text-base md:text-lg lg:text-xl leading-7.5 text-secondary cursor-pointer ${currentPage == 1 ? 'bg-primary text-white' : 'hover:bg-gray-200'}`}>1</button>
                ...
                <button onClick={() => onPageChange(totalPages)} className={`size-8 lg:size-12 flex justify-center items-center rounded-sm font-poppins font-semibold text-base md:text-lg lg:text-xl leading-7.5 text-secondary cursor-pointer ${currentPage == totalPages ? 'bg-primary text-white' : 'hover:bg-gray-200'}`}>{totalPages}</button>
            </div>
