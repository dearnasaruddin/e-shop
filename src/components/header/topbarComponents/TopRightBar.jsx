    ...
    return (
        <div className='flex items-center gap-x-6 font-montserrat font-normal text-sm leading-5 text-[#303030]'>
            ...
            <div>
                ...
                <div onClick={() => setIsCurrencyDropdownOpen(!isCurrencyDropdownOpen)} className="relative flex items-center gap-x-2 cursor-pointer">
                    ...
                    {isCurrencyDropdownOpen &&
                        <ul className='w-18 absolute top-10.5 -left-2  border border-gray-300 z-10'>
            ...
            <div className='w-full px-6 relative before:absolute before:h-8 before:w-[1px] before:-left-0 before:top-1/2 before:-translate-y-1/2 before:bg-[#CBCBCB] after:absolute after:h-8 after:w-[1px] after:-right-0 after:top-1/2 after:-translate-y-1/2 after:bg-[#CBCBCB] cursor-pointer'>
                ...
                {/* ====== options ====== */}
                {isLangDropdownOpen &&
                    <ul className='w-10/12 absolute top-10.5 left-1/2 -translate-x-1/2 border border-gray-300 z-10'>
                        {countries.map((country) => (
