...
const TopLeftBar = () => {
    return (
        <div className='flex items-center gap-x-12.5 font-montserrat font-normal text-sm leading-5 text-[#303030] relative after:absolute after:h-8 after:w-[1px] after:left-[62%] after:top-1/2 after:-translate-y-1/2 after:bg-[#CBCBCB]'>
