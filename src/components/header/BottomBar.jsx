  ...
  return (
    <>
      <div className='bg-primary hidden sm:block sm:sticky sm:top-0 sm:z-20'>
        <CategoriesSideBar />
        <Container>
          <div className="flex items-center justify-between py-3.5 lg:py-6 font-montserrat font-bold text-base gap-x-6 sm:max-md:text-sm leading-6 text-white">
            <ul className='flex items-center sm:gap-x-6 md:gap-x-8 lg:gap-x-20'>
      ...
      <div className={`bg-white h-screen w-full fixed top-0 z-50 pl-6 pt-10 pr-14 sm:hidden ${selector ? 'left-0' : '-left-full'} duration-200`}>
        ...
        <div className="font-montserrat font-bold text-base leading-6 text-secondary">
          <ul className=''>
            ...
            {isProductDropdownOpenForMobile &&
              <ul className='font-montserrat font-normal whitespace-nowrap text-base text-secondary pl-4'>
                ...
                <li className=' hover:bg-gray-200'>
                  <Link onClick={() => dispatch(disableNavSideBar())} className='py-2 px-4 block' to={'#featured-products'}>Featured Products</Link>
                </li>
                {/* <li className=' hover:bg-gray-200'>
                  <Link onClick={() => dispatch(disableNavSideBar())} className='py-2 px-4 block' to={'#'}>New Products</Link>
                </li> */}
                <li className=' hover:bg-gray-200'>
                  <Link onClick={() => dispatch(disableNavSideBar())} className='py-2 px-4 block' to={'#spring-sale'}>Spring Sale</Link>
                </li>
                {/* <li className=' hover:bg-gray-200'>
                  <Link onClick={() => dispatch(disableNavSideBar())} className='py-2 px-4 block' to={'#best-seller'}>Best Seller</Link>
                </li> */}
              </ul>
            }
          ...
          <ul className=''>
            ...
            <li><Link onClick={() => dispatch(disableNavSideBar())} to={'#best-seller'} className='block hover:bg-gray-200 py-2 px-4'>Best Seller</Link></li>
            <li><Link onClick={() => dispatch(disableNavSideBar())} to={'#new-products'} className='block hover:bg-gray-200 py-2 px-4'>New Arrival</Link></li>
          </ul>
        </div>
      </div>
