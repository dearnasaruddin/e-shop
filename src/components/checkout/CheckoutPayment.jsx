        ...
        <div >
            ...
            <div className="flex flex-col gap-4 lg:gap-8">
                {paymentMethods.map((item) => (
                    <label
                        key={item.id}
                        className={`p-2 lg:p-4 lg:w-216 rounded-lg border cursor-pointer transition flex items-center
                        ...
                        />
                        <div className="ml-4">
                            <div className="font-poppins text-lg lg:text-xl font-semibold">{item.label}</div>
                ...
                selected === "card" && (
                    <div className="mt-6 space-y-4 lg:space-y-8">
                        <input
                            ...
                            className="w-full border font-montserrat text-base border-gray-300 rounded px-4 py-4 lg:py-7"
                        />
                        <div className="flex gap-4">
                            <input
                                type="text"
                                placeholder="MM/YY"
                                className="w-1/2 border font-montserrat text-base border-gray-300 rounded px-4 py-4 lg:py-7"
                            />
                            <input
                                type="text"
                                placeholder="CVC"
