...
const CheckoutInformation = () => {
    ...
    return (
        < div >
            <h3 className='font-poppins font-semibold max-xxs:text-xl xxs:text-2xl lg:text-4xl leading-11.5 text-secondary mb-4 lg:mb-10' > Billing Details</h3 >
            <div className='w-auto 2xl:w-216'>
                ...
                <div className='flex gap-x-4 lg:my-8 flex-wrap'>
                    <div className='grow'>
                ...
                <div className='flex gap-x-4 lg:mt-8 flex-wrap'>
                    <div className='grow relative'>
                        <InputBox value={selectedCountry} label='Country' required={true} placeholder='Indonesia' handleInputValue={handleInputValue} />

                        {/* Countries Dropdown */}
                        <span onClick={() => setActiveCountry(!activeCountry)} className='absolute max-lg:top-4/7 lg:bottom-7 max-lg:right-4 lg:right-6.5 cursor-pointer'><ArrowDownIcon className='size-6' /></span>
                        {activeCountry &&
                    ...
                    <div className='grow relative'>
                        ...
                        {/* State Dropdown */}
                        <span onClick={() => setActiveState(!activeState)} className='absolute max-lg:top-4/7 lg:bottom-7 max-lg:right-4 lg:right-6.5 cursor-pointer'><ArrowDownIcon className='size-6' /></span>
                        {activeState &&
                ...
                <div className='flex gap-x-4 lg:my-8 flex-wrap'>
                    <div className='grow relative'>
                        ...
                        {/* City Dropdown */}
                        <span onClick={() => setActiveCity(!activeCity)} className='absolute max-lg:top-4/7 lg:bottom-7 max-lg:right-4 lg:right-6.5 cursor-pointer'><ArrowDownIcon className='size-6' /></span>
                        {activeCity &&
