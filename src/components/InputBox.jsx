    ...
    return (
        <>
            ...
            {textArea ?
                ...
                :
                <input onChange={(e) => handleInputValue(e.target.value)} value={value} id={label} className='w-full py-2 lg:py-6 px-4 lg:px-8 font-montserrat font-normal text-base lg:text-xl leading-7.5 placeholder:text-[#646464] text-black border border-[#CBCBCB] rounded-lg lg:rounded-[10px]' type={type} placeholder={placeholder} />
            }
        </ >
    )
}
