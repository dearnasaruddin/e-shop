...
const InputBox = ({ label = 'Name', placeholder = 'Enter your', type='text', required = false, textArea = false, minHeight = '240px' }) => {
    return (
        <>
            ...
            {textArea ?
                ...
                :
                <input id={label} className='w-full py-6 px-8 font-montserrat font-normal text-xl leading-7.5 text-[#646464] border border-[#CBCBCB] rounded-[10px]' type={type} placeholder={placeholder} />
            }
        </>
    )
}
